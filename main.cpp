...
int main() {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    setenv("CYCLONEDDS_URI", "file:///home/wcy/humanoid_proj/z1_rl/dds_helper/dds_config/NetworkInterface.xml", 1); // 覆盖当前进程的环境变量
    ...
    if (bool Ethernet_Status = CAT_Init("enp8s0"); !Ethernet_Status) { exit(1); } //如果初始化失败，则直接退出程序
