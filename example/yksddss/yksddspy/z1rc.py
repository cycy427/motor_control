...
if __name__ == '__main__':
    ...
    # z1_arm.motorCmds.cmds[18-12].mode = 0
    # z1_arm.motorCmds.cmds[18-12].pos = 3
    # z1_arm.motorCmds.cmds[18-12].vel = 0
    # z1_arm.motorCmds.cmds[18-12].tau = 0
    # z1_arm.motorCmds.cmds[18-12].kp = 400
    # z1_arm.motorCmds.cmds[18-12].kd = 20
